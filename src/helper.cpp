...
/*
 * ============================================================
 * DEBUG DRAWING THICKNESS
 * ============================================================
 *
 * Change these two values to adjust the debug overlay.
 *
 * DEBUG_RECT_THICKNESS:
 *   Blue face-detection / green tracking rectangles.
 *
 * DEBUG_LANDMARK_THICKNESS:
 *   Facial landmark lines.
 *
 * Values are approximately source-image pixels.
 */

static constexpr float DEBUG_RECT_THICKNESS = 0f;
 ...
 * we want, so we create actual geometry instead.
 */
...
/*
 * Draw facial landmarks with configurable thickness.
 *
 * Supports the two landmark layouts used by the plugin:
 *
 *   5-point
 *   68-point
 */
void draw_landmark(const std::vector<pointf_s> &landmark)
{
	...
	/*
	 * Convenience function for connecting two landmark points.
	 */
	 ...
	 * ========================================================
	 *
	 * Preserve the connection order used by the original
	 * helper.cpp:
	 *
	 * 0 -> 1 -> 3 -> 2 -> 4 -> 0
	 */
	...
	/*
	 * Don't make assumptions about an unknown landmark model.
	 */
	if (landmark.size() != 68)
		return;
